...
public class addFlight extends javax.swing.JInternalFrame {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(39, 39, 39)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtflightname, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(txtsource, javax.swing.GroupLayout.Alignment.LEADING, 0, 149, Short.MAX_VALUE)
                                        .addComponent(txtdepart, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))
                        .addGap(98, 98, 98)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
            ...
            if(txtflightid.getText().equals("") || txtflightname.getText().equals("")||txtsource.getSelectedItem().toString().equals(txtdepart.getSelectedItem().toString())||txtarrtime.getText().equals("")||txtdeparttime.getText().equals("")||txtdate.getDate()==null||txtflightcharge.getText().equals(""))
        {
        ...
        String flightcharge = txtflightcharge.getText();
            ...
            Class.forName("com.mysql.jdbc.Driver");
             ...
             pst = con.prepareStatement("insert into flight(FlightId,FlightName,Source,Departure,Date,DepTime,ArrTime,FlightCharge)values(?,?,?,?,?,?,?,?)");
             ...
             pst.executeUpdate();
             JOptionPane.showMessageDialog(null, "Trip is Created Successsfully!......");
...
this.hide();
    ...
    public void autoID()
    {
        try {
            Class.forName("com.mysql.jdbc.Driver");
       con= DriverManager.getConnection("jdbc:mysql://localhost/airline","root","");     
          ResultSet rs = con.createStatement().executeQuery("select MAX(FlightId) from flight");
          rs.next();
